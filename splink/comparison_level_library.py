...
class BinaryHammingSimilarityBase(DistanceFunctionLevelBase):
    def __init__(
        self,
        col_name: str,
        distance_threshold: int | float,
        ...
        super().__init__(
            col_name,
            self._binary_hamming_similarity_name,
            distance_threshold=distance_threshold,
            regex_extract=regex_extract,
            set_to_lowercase=set_to_lowercase,
            higher_is_more_similar=True,
        ...
        def _binary_hamming_similarity_name(self):
            raise NotImplementedError(
                "Binary hamming similarity function name not defined on base class"
            )
